    ...
    return {
      initTags: [
        ...
        },
        {
            ...
            fullPath:"/manage/add-popup"
        },
        {
            name:"modelblacklist",
            meta:{
                tagId:"modelblacklist",
                title:"机型黑名单"
            },
            fullPath:"/manage/modelblacklist"
        },
        {
            name:"macblacklist",
            meta:{
